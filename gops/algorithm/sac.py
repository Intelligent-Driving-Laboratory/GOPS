...
class ApproxContainer(ApprBase):
    ...
    def __init__(self, **kwargs):
        ...
        # create optimizers
        self.q1_optimizer = self.optimizer(self.q1.parameters(), lr=kwargs["q_learning_rate"])
        self.q2_optimizer = self.optimizer(self.q2.parameters(), lr=kwargs["q_learning_rate"])
