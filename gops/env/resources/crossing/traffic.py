        ...
        for egoID, ego_dict in self.n_ego_dict.items():
            ...
            for veh in random_traffic:
                ...
                (
                    ...
                    ego_y_in_veh_coord,
                    ego_a_in_veh_coord,
                ) = shift_and_rotate_coordination(0, 0, 0, x_in_ego_coord, y_in_ego_coord, a_in_ego_coord)
                if (
    ...
    def set_own_car(self, n_ego_dict_):
        ...
        for egoID in self.n_ego_dict.keys():
            ...
            (
                ...
                ego_y_in_sumo,
                ego_a_in_sumo,
            ) = _convert_car_coord_to_sumo_coord(ego_x, ego_y, ego_phi, self.n_ego_dict[egoID]["l"])
