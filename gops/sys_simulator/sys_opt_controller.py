...
class OptController:
    ...
    def _cost_fcn_and_jac(self, inputs: np.ndarray, x: torch.Tensor, info: InfoDict) -> Tuple[float, np.ndarray]:
        """
    ...
    def _constraint_jac(self, inputs: np.ndarray, x: torch.Tensor, info: InfoDict) -> np.ndarray:
        """
    ...
    def _trans_constraint_jac(self, inputs: np.ndarray, x: torch.Tensor, info: InfoDict) -> np.ndarray:
        """
    ...
    def _rollout(self, inputs: torch.Tensor, x: torch.Tensor, info: InfoDict) -> Tuple[torch.Tensor, torch.Tensor]:
        """
    ...
    def _compute_cost(self, inputs: torch.Tensor, x: torch.Tensor, info: InfoDict) -> torch.Tensor:
        """
