...
if __name__ == "__main__":
    ...
    parser.add_argument('--env_id', type=str, default='gym_bipedalwalkerhardcore')
    ...
    parser.add_argument('--max_iteration', type=int, default=int(1e6))
    ...
    if trainer_type == 'off_async_trainer':
        ...
        ray.init()
        parser.add_argument('--num_algs', type=int, default=5, help='number of algs')
