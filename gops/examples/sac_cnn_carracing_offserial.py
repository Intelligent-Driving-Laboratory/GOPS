...
if __name__ == "__main__":
    ...
    # Options: MLP/CNN/RNN/POLY/GAUSS
    parser.add_argument('--q_func_type', type=str, default='CNN')
    q_func_type = parser.parse_args().q_func_type
    ### 2.1.1 MLP, CNN, RNN
    if q_func_type == 'CNN':
        ...
        parser.add_argument('--q_conv_type', type=str, default='type_2')
