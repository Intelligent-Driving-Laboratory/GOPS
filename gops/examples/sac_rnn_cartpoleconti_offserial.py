...
if __name__ == "__main__":
    ...
    parser.add_argument('--env_id', type=str, default='gym_cartpolecontiwithstack')
    ...
    parser.add_argument('--value_func_type', type=str, default='RNN')
    value_func_type = parser.parse_args().value_func_type
    ### 2.1.1 MLP, CNN, RNN
    if value_func_type == 'RNN':
        parser.add_argument('--value_hidden_sizes', type=list, default=[32, 64, 64])
    ...
    # Options: MLP/CNN/RNN/POLY/GAUSS
    parser.add_argument('--q_func_type', type=str, default='RNN')
    value_func_type = parser.parse_args().value_func_type
    ### 2.1.1 MLP, CNN, RNN
    if value_func_type == 'RNN':
        parser.add_argument('--q_hidden_sizes', type=list, default=[32, 64, 64])
        # Hidden Layer Options: relu/gelu/elu/sigmoid/tanh
    ...
    # Options: MLP/CNN/RNN/POLY/GAUSS
    parser.add_argument('--policy_func_type', type=str, default='RNN')
    policy_func_type = parser.parse_args().policy_func_type
    ### 2.2.1 MLP, CNN, RNN
    if policy_func_type == 'RNN':
        parser.add_argument('--policy_hidden_sizes', type=list, default=[32, 64, 64])
        # Hidden Layer Options: relu/gelu/elu/sigmoid/tanh
