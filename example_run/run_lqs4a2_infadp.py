...
value_net = load_policy("../results/INFADP/221207-144854", "2000").v
policy_net = load_policy("../results/INFADP/221207-144854", "3000").policy
...
runner = PolicyRunner(
    log_policy_dir_list=["../results/INFADP/221207-144854"] * 1,
    trained_policy_iteration_list=["2000"],
    is_init_info=True,
    init_info={"init_state": [0.5, 0.2, 0.5, 0.1]},
    save_render=False,
    legend_list=["INFADP-2000"],
    use_opt=True,
    opt_args={
