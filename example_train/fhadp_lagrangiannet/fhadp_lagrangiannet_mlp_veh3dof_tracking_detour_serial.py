...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--multiplier_func_name",
        type=str,
        default="MultiplierNet"
    )
    parser.add_argument("--multiplier_func_type", type=str, default="MLP")
    parser.add_argument("--multiplier_act_distribution", type=str, default="default")
    policy_func_type = parser.parse_known_args()[0].policy_func_type
    parser.add_argument("--multiplier_hidden_sizes", type=list, default=[32, 32])
    parser.add_argument("--multiplier_hidden_activation", type=str, default="gelu")    
    ################################################
