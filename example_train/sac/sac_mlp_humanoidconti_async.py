...
if __name__ == "__main__":
    ...
    parser.add_argument("--q_learning_rate", type=float, default=8e-5)
    ...
    parser.add_argument("--max_iteration", type=int, default=3000000)
    ...
    parser.add_argument("--buffer_warm_size", type=int, default=6000)
    # Max size of reply buffer
    parser.add_argument("--buffer_max_size", type=int, default=3*500000)
    ...
    alg = create_alg(**args)
    for alg_id in alg:
        alg_id.set_parameters.remote({"tau": 0.001})
