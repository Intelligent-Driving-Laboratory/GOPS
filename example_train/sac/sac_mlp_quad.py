...
#
#  Description: example for sac + pendulum + mlp + off_serial
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_id", type=str, default="quadrotor_1dof_tracking_stablization", help="id of environment")
