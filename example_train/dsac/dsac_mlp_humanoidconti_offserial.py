...
if __name__ == "__main__":
    ...
    parser.add_argument("--value_min_log_std", type=int, default=-20)
    parser.add_argument("--value_max_log_std", type=int, default=0.5)
    ...
    parser.add_argument("--value_learning_rate", type=float, default=1e-5)
