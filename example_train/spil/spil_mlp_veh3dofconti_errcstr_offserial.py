...
#
#  Description: example for spil + mobilerobot + veh3dofconti_errcstr + mlp + off_serial
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_id", type=str, default="pyth_veh3dofconti_errcstr", help="id of environment")
