...
#
#  Description: example for infhadp + lqs5a1 + mlp + off_serial
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lq_config", type=str, default="s5a1", help="config of lq")
    ...
    init_mean = np.array([0, 0, 0, 0, 0], dtype=np.float32)
    init_std = np.array([1, 1, 1, 1, 1], dtype=np.float32)
