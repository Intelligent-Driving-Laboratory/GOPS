...
if __name__ == "__main__":
    ...
    if value_func_type == 'MLP':
        ...
        parser.add_argument('--q_max_log_std', type=int, default=2)
    ...
    parser.add_argument('--q1_learning_rate', type=float, default=1e-3)
    parser.add_argument('--q2_learning_rate', type=float, default=1e-3)
