...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_mini_batch', type=int, default=1, help='1')  # 8 mini_batch
    parser.add_argument('--mini_batch_size', type=int, default=1, help='1')  # 8 mini_batch * 128 = 1024
