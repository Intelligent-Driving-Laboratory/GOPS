...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_id", type=str, default="simu_cartpoleconti") # simu_lqs2a1conti
    ...
    parser.add_argument("--rand_center", type=list, default=[0, 0])
    parser.add_argument("--rand_bias", type=list, default=[1, 1])
    parser.add_argument("--punish_Q", type=list, default=[2, 1])
    parser.add_argument("--punish_R", type=list, default=[1])
    parser.add_argument("--punish_done", type=list, default=0.)
    ################################################
    ...
    alg = create_alg(**args)
    alg.set_parameters(
        {"reward_scale": 1.0, "gamma": 0.99, "tau": 0.2, "delay_update": 1}
    )
