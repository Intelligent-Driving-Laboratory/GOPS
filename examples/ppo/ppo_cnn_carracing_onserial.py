...
#  Update Date: 2022-10-23, Liu Tong: modify and debug gops.utils
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env_id', type=str, default='gym_carracing', help='')
    ...
    parser.add_argument('--policy_min_log_std', type=int, default=-6)  # -6
    parser.add_argument('--policy_max_log_std', type=int, default=6)  # 3
    ...
    parser.add_argument('--max_iteration', type=int, default=200, help='8000')  # 1200 gradient step
    ...
    parser.add_argument('--mini_batch_size', type=int, default=256, help='256')  # 25 mini_batch * 128 = 3200
