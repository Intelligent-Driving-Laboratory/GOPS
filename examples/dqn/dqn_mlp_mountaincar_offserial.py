...
#
#  Creator: iDLab
#  Description: gym environment，discrete action，DQN algorithm, MLP, gym-mountaincar, off serial trainer
#  Update Date: 2022-11-07, Liu Tong
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_id", type=str, default="gym_mountaincar")
    ...
    parser.add_argument("--noise_params", type=dict, default={"epsilon": 0.4})
