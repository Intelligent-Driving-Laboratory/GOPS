...
#
#  Description: example for infhadp + lqs6a1 + mlp + off_serial
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lq_config", type=str, default="s6a3", help="config of lq")
    ...
    parser.add_argument("--max_iteration", type=int, default=150000)
    ...
    alg.set_parameters({"gamma": 0.99, "tau": 0.2,"forward_step":50})
