...
#  Update Date: 2021-07-11, Yuxuan Jiang & Guojian Zhan: TRPO with cartpole
...
if __name__ == "__main__":
    ...
    parser.add_argument("--action_num", type=int, default=None)  # dim(Action)
    ...
    alg = create_alg(**args)
    alg.set_parameters({"reward_scale": 0.1, "gamma": 0.99})
