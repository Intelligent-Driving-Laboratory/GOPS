...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--is_render", type=bool, default=True
    ...
    if policy_func_type == "MLP":
        ...
        # Output Layer: tanh
        parser.add_argument(
            "--policy_output_activation", type=str, default="linear"
        )  # already tanh-ed in mlp
    ...
    if trainer_type == "on_sync_trainer":
        parser.add_argument(
            "--num_epoch", type=int, default=1, help="# 50 gradient step per sample"
        )
        import ray
